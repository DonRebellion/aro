...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const mailtoButton = document.getElementById("botao-enviar-email");
    ...
    Sou residente em ${freguesia} e escrevo por causa dos caixotes de lixo da minha rua.
    ...
    Existe uma solução simples, já usada há anos noutros países: o aro, um pequeno suporte em aço que se fixa aos caixotes de lixo já existentes. Quem não quer o reembolso pousa ali a garrafa ou a lata; quem a quer leva-a com a mão, sem tocar no lixo e sem espalhar nada. Está tudo explicado em arourbano.pt.

    O meu pedido é simples: que considerem testar aros na nossa cidade. Bastariam os caixotes de lixo da ${ruas} para perceber se resulta. Em arourbano.pt encontram o contacto da equipa, que faz uma visita técnica sem compromisso.
